...
{#if $page.data.session?.user}
    <main class="">
        ...
        <div class="mx-4 my-12">
            <h1 class="text-xl border-b border-b-primary-800 pb-2"><a class="text-primary-500">{data.body.length}</a> Listings Available</h1>
        </div>
                ...
                <div class="flex items-center justify-center">
                    ...
                    >
                        ...
                        <div class=" ">
                            ...
                            <!-- short description -->
                            <div class="mx-4 py-1 pb-2 mb-1 text-primary-700 border-b border-b-primary-800">
                            ...
                            <!-- number of beds -->
                            <div class="px-4 py-2">
                                <p class=" text-primary-200 text-sm"><a class="text-primary-600">{listing.beds}</a> {listing.beds > 1 ? ' Beds' : ' Bed'}</p> 
                            </div>

                            <!-- price and rating -->
                            <div class="px-4 mb-4 flex justify-between">
                                <h2 class=" text-sm"><a class="text-primary-600">${listing.price}.00</a> night</h2>

                                <div class="flex gap-2 items-center text-sm">
                                    <i class="fa-solid fa-star"></i>
                                    <h2 class="text-primary-600">{listing.review_scores.review_scores_rating === undefined ? "No Rating" : listing.review_scores.review_scores_rating}</h2>
                                </div>
                            </div>
                        </div>
